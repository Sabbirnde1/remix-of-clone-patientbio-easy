...
import { Stethoscope, Mail, Lock, ArrowRight, ArrowLeft, CheckCircle2, AlertCircle } from "lucide-react";
...
const DoctorAuthPage = () => {
  ...
  // Check if user already has doctor profile and redirect
  useEffect(() => {
  ...
  // Show loading while checking profile for logged-in user
  if (user) {
    return (
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-white/80 text-lg max-w-md">
            Manage your patients, issue digital prescriptions, and streamline your practice with Patient Bio.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-8">
        <div className="w-full max-w-md">
                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <Button
                        type="submit"
                        size="lg"
                        className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 border-0"
                        disabled={isLoading}
                      >
              ...
              <>
                <div className="text-center mb-6 sm:mb-8">
                  <h2 className="text-xl sm:text-2xl font-bold mb-2">
                    {view === "login" ? "Welcome back, Doctor" : "Create your account"}
                  </h2>
                  <p className="text-sm sm:text-base text-muted-foreground">
                    {view === "login"
          ...
          <div className="mt-6 text-center text-sm text-muted-foreground space-y-2">
            ...
            <p>
              Are you a hospital?{" "}
              <Link to="/hospitals/login" className="text-primary hover:underline font-medium">
                Hospital Portal
              </Link>
            </p>
          </div>
