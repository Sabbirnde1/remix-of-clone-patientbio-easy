...
import { Loader2, Plus, Trash2, CalendarIcon, Pill } from "lucide-react";
...
export const CreatePrescriptionDialog = ({
  ...
  const onSubmit = async (data: FormData) => {
    // Transform the data to match the Medication type (all fields are guaranteed by zod validation)
