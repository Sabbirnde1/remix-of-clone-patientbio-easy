...
const Investors = () => {
  ...
  return <section id="investors" className="py-24 relative overflow-hidden">
      <div className="absolute inset-0 bg-[var(--gradient-mesh)] pointer-events-none" />
      
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="inline-flex items-center px-4 py-2 rounded-full bg-secondary/10 text-secondary text-sm font-medium mb-6"> Investor Relations</span>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {metrics.map((metric, index) => <div key={index} className="p-6 rounded-2xl bg-card border border-border/50 text-center hover:border-primary/30 hover:shadow-lg transition-all duration-300">
        ...
        <div className="bg-card rounded-2xl border border-border/50 p-8 mb-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {investors.map((investor, index) => <div key={index} className="p-4 rounded-xl bg-muted/50 border border-border/50 flex items-center gap-4">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {press.map((item, index) => <div key={index} className="p-6 rounded-2xl bg-gradient-to-br from-primary/5 to-secondary/5 border border-primary/10">
