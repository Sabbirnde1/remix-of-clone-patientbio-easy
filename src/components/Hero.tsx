      ...
      <div className="container mx-auto max-w-6xl relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {[
            ...
            <div
              key={index}
              className="group relative bg-card rounded-3xl p-8 text-center shadow-[var(--card-shadow-lg)] hover:shadow-[var(--card-shadow-xl)] transition-all duration-300 border border-border/50 hover:border-primary/30 backdrop-blur-sm"
